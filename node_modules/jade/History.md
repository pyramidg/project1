...
==================
  ...
  * Improved runtime performance of ejs's string escaping ([Andreas Lubbe](https://github.com/alubbe)) and ([@ForbesLindesay](http://www.forbeslindesay.co.uk/))
...
==================
  ...
  * Use variables instead of properties of ejs, improving performance and reliability with nested templates ([@ForbesLindesay](http://www.forbeslindesay.co.uk/))
...
===================
  ...
  * remove `ejs.version` and fix `ejs --version`
...
==================
  ...
  * Allow the compiled client to use it's own ejs util functions [3rd-Eden]
...
==================
  ...
  * Added ejs manpage (`man ejs` after installation for docs)
  * Added `-D, --no-debug` to ejs(1)
  * Added `-p, --pretty` to ejs(1)
  * Added `-c, --client` option to ejs(1)
...
==================
  ...
  * Changed: replaced internal `__` var with `__ejs` [chrisleishman]
...
==================
  ...
  * Added link in readme to ejs-mode for Emacs
...
==================
  ...
  * ejs.renderFile() is back! (for express 3.x)
...
==================
  ...
  * Fixed: include files with a .ejs extension as ejs files
...
==================
  ...
  * Fixed ejs(1) support due to `res.render()` removal
...
==================
  ...
  * Removed `ejs.render()` and `ejs.renderFile()`
...
==================
  ...
  * Added `include` support for non-ejs files
...
==================
  ...
  * Added `ejs.js` for the client-side to the repo
  * Added `ejs.min.js` for the client-side to the repo
...
==================
  ...
  * Added client-side browser support via `make ejs.js` and `make ejs.min.js`.
...
==================
  ...
  * Added `mkdirs()` to ejs(1)
  * Added ejs(1) stdio support
  * Added new features to ejs(1), `--watch`, recursive compilation etc [khingebjerg]
  * Fixed pipe-less text newlines
  * Removed ejs(1) `--pipe` flag
...
==================
  ...
  * Added; Text introduces newlines to mimic the grammar.
    ...
    ejs will now mimic the written grammar, meaning that text blocks
    using the "|" margin character will introduce a literal newline,
    where as immediate tag text (ex "a(href='#') Link") will not.

    This may not be ideal, but it makes more sense than what ejs was
    previously doing.
...
==================
  ...
  * Added support for `ejs.renderFile()` to utilize primed cache
  * Added link to [textmate bundle](http://github.com/miksago/ejs-tmbundle)
