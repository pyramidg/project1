...
## 2.0.1 - 2013-04-22
 ...
 - Fix global leak of `exportscoffeeScript` (test still fails because `ejs` requires an out of date version of `transformers`)
...
## 1.7.0 - 2013-01-30
 ...
 - **component-js**
 - **component-css**
 - **html2ejs** - must be `v0.0.7` because of a bug in later versions
