...
exports.ejs = new Transformer({
  name: 'ejs',
  engines: ['ejs', 'then-ejs'],
  outputFormat: 'xml',
  sudoSync: 'The ejs file FILENAME could not be rendered syncronously.  N.B. then-ejs does not support syncronous rendering.',
  async: function (str, options, cb) {
    this.cache(options, true);//ejs handles this.cache internally
...
exports['html2ejs'] = new Transformer({
  name: 'html2ejs',
  engines: ['html2ejs'],
  outputFormat: 'ejs',
  async: function (str, options, cb) {
